using ProdavnicaNamestaja.Util;
using System;
...
namespace ProdavnicaNamestaja.model
{
    public class Projekat
    {
        ...
        {
            get { this.namestaj= GenericsSerializer.DeSerialize<Namestaj>("namestaj.xml");
        ...
        public List<TipNamestaja> TipoviNamestaja
        {
            get { this.tipoviNamestaja = GenericsSerializer.DeSerialize<TipNamestaja>("tipNamestaja.xml");
